...
.. toctree::
  ...
  make TDD with variables<make_tdd/make_tdd_automatically_w_variables/index>
...
Start with how to make a Python Test Driven Development environment manually because it is needed by every other chapter, each chapter suggests the next chapter to do, or you can choose how you go through the chapters based on what you like. You can also go through the :ref:`how tos` section step by step, the other chapters cover :ref:`errors`, :ref:`basic objects`, :ref:`functions<what is a function?>`, and :ref:`classes<everything is an object>`
