...
* do not quit until you get to the end of a chapter, especially when it gets hard, it is part of the experience when learning to solve problems, because there is a lot of failure. You can always walk away from the chapter to do something different for a while, then come back to it. If you take one small step at a time you eventually get where you want to go
