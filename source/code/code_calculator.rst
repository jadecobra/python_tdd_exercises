...
.. literalinclude:: calculator/tests/test_calculator_exceptions_tests.py
  :language: python
  :linenos:
...
.. literalinclude:: calculator/tests/test_calculator_lists.py
  :language: python
  :linenos:
...
.. literalinclude:: calculator/solutions/calculator_lists.py
  :language: python
  :linenos:
