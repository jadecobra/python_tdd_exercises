...
* the code from ``person/tests/test_person.py`` from :ref:`how to make a person`

  .. literalinclude:: person/tests/test_person.py
    :language: python
    :linenos:

* the code from ``person/tests/test_person.py`` from :ref:`classes`
...
* the solution in ``person/src/person.py`` from :ref:`classes`
