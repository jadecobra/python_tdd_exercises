...
* I copy (:kbd:`ctrl/command+c`) the values from the terminal_ and paste (:kbd:`ctrl/command+v`) them as ``my_expectation``
  ...
  - The :ref:`__init__ method<the constructor method>` is also inherited which means when I defined it in :ref:`the constructor method` I overwrote the inherited one.
