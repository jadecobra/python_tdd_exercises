...
*********************************************************************************
test_is_none_a_object with unittest
*********************************************************************************
...
* I move :ref:`test_is_none_a_object` to make it a :ref:`method<what is a method?>` of the :ref:`TestClasses class<add TestClasses class>`
  ...
  .. code-block:: python
    ...
    TypeError:
        TestClasses.test_is_none_a_object()
        takes 0 positional arguments but 1 was given
...
I add ``self`` to the parentheses of :ref:`test_is_none_a_object`
...
* I remove the other commented lines from :ref:`test_is_none_a_object`
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am \
    'move test_is_none_a_object to TestClasses'
