...
The ``dir`` :doc:`method </functions/functions>` returns a :doc:`list </data_structures/lists>` of all attributes and :doc:`methods </functions/functions>` of the object provided to it as input
