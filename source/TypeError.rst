...
* Open a new file in the editor and save it as ``tests/test_type_error.py`` in the ``tests`` folder you created in :doc:`Setup a Test Driven Development Environment` and type the following in the file
