...
* ``AssertionError: True is not false`` the :py:exc:`Exception`raised and its message, in this case :ref:`AssertionError` is raised because :ref:`True<test_what_is_true>` is not :ref:`False<test_what_is_false>`
