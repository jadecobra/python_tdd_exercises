.. meta::
  ...
  :keywords: Jacob Itegboje, Pumping Python, how to make a person with strings, python TDD variables, NameError: name 'joe' is not defined, TypeError: 'NoneType' object is not callable, bare assert, pytest-watcher "no tests ran", functions that return strings, red green refactor, repetition in tests, person attributes as variables, what is next mafunctions that take input
