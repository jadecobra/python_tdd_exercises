...
* I add a failing test to see what happens when I pass a :ref:`class <everything is an object>` from a test to the ``text`` :ref:`function<what is a function?>`, to ``test_telephone.py``
  ...
  :ref:`object<everything is an object>` is the :ref:`mother class<everything is an object>` that all :ref:`Python objects<everything is an object>` come from because :ref:`everything in Python is an object<everything is an object>`.
