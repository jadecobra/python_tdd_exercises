...
* I use touch_ to make an empty file_ for the program_ in the ``src`` folder_
  ...
  .. attention:: on Windows without `Windows Subsystem for Linux`_ use ``New-Item src/calculator.py`` instead of ``touch src/calculator.py``
...
* I make an empty file_ for the actual test
  ...
  .. attention:: on Windows without `Windows Subsystem for Linux`_ use ``New-Item tests/test_calculator.py`` instead of ``touch tests/test_calculator.py``
