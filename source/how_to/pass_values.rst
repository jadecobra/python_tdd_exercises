...
* I use touch_ to make an empty file_ for the program_ in the ``src`` folder_
  ...
  .. attention:: on Windows without `Windows Subsystem for Linux`_ use ``New-Item src/telephone.py`` instead of ``touch src/telephone.py``
...
* I make an empty file_ for the actual test
  ...
  .. attention:: on Windows without `Windows Subsystem for Linux`_ use ``New-Item tests/test_telephone.py`` instead of ``touch tests/test_telephone.py``
