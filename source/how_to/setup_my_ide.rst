...
* `Python <https://marketplace.visualstudio.com/items?itemName=ms-python.python>`_ - Python_ language support with Pylance and a `Python <https://docs.python.org>`_` debugger
