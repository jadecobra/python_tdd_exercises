...
* I add a :ref:`for loop<what is a for loop?>` for all the buttons, in ``test_streamlit_calculator.py``
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` for 18 sub tests
...
* I add ``streamlit.errors.StreamlitDuplicateElementKey`` to the list of :ref:`Exceptions<how to test if an Exception is raised>` seen, in ``test_streamlit_calculator.py``
...
* I check the browser and see all the buttons and the :ref:`Exception<how to test if an Exception is raised>`
...
* I add a :ref:`for loop<what is a for loop?>` for all the buttons in the first column, in ``test_streamlit_calculator.py``
  ...
  the terminal_ is my friend, and shows :ref:`AssertionError<what causes AssertionError?>` for the ``<-`` button
...
* I call the new :ref:`function<what is a function?>` in the ``add_buttons`` :ref:`function<what is a function?>`
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` and ``streamlit.errors.StreamlitDuplicateElementKey``
...
* All the :ref:`for loops<what is a for loop?>` in :ref:`test_streamlit_calculator_columns_and_buttons` look like this
  ...
  the terminal_ is my friend, and shows :ref:`AssertionError<what causes AssertionError?>` for 20 sub tests
...
* I add a parameter for the ``display`` :ref:`variable<what is a variable?>` in the :ref:`function<what is a function?>` signature for ``add_buttons_to_column_1``
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` for 27 sub tests and the terminal_ for the streamlit_ application shows :ref:`TypeError<what causes TypeError?>`
...
* I add ``display`` to the :ref:`function<what is a function?>` signature of the ``add_buttons_to_column_2`` :ref:`function<what is a function?>`
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` for 22 sub tests and the terminal_ for the application shows :ref:`TypeError<what causes TypeError?>`
...
* I make the same change for the numbers in the third column
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` for 14 sub tests
...
* I add ``display`` to the signature of the ``add_buttons_to_column_3`` :ref:`function<what is a function?>`
  ...
  the terminal_ is my friend, and shows :ref:`KeyError<test_key_error>` and the terminal_ for the application shows :ref:`TypeError<what causes TypeError?>`
