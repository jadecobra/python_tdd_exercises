...
I use ``**`` like I did for the :ref:`keyword arguments<test_keyword_arguments>` in :ref:`test_unknown_number_of_arguments`
...
* I add a :ref:`for loop<what is a for loop?>` to use the ``self.arithmetic_tests`` :ref:`dictionary<what is a dictionary?>` in :ref:`test_calculator_w_list_items`
...
I added these tests for the :ref:`calculator program<how to make a calculator 5>` with :ref:`dictionaries<what is a dictionary?>` which made testing the program easier
