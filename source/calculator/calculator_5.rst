...
.. literalinclude:: ../code/calculator/tests/test_calculator_5.py
  :language: python
  :linenos:
...
I can use a `starred expression`_ to unpack the :ref:`list<what is a list?>` in an :ref:`assertion<what is an assertion?>` like the :ref:`positional arguments<test_w_positional_arguments>` in :ref:`test_w_unknown_arguments`
