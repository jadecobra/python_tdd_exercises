.. meta::
  :description: Python truth table hub for all 16 binary operations — two inputs (True/False), four input combinations each, one boolean output. Master table covers contradiction (always False), tautology (always True), logical_conjunction (AND), logical_disjunction (OR), logical_nand, logical_nor, exclusive_disjunction (XOR), logical_equality, material_implication, material_non_implication, converse_implication, converse_non_implication, project_first, project_second, negate_first, negate_second. Step through Binary Operations 1–4 with TDD (if statements, and/or/not, nested conditions, ternary conditional expressions, De Morgan refactoring) and Binary Operations 5 real-world examples. Preview test_binary.py with unittest assertTrue/assertFalse. Requires Nullary and Unary Operations. Jacob Itegboje Pumping Python.
  :keywords: Jacob Itegboje, Pumping Python, python truth table binary operations, 16 logic gates python, logical conjunction AND truth table, logical disjunction OR, NAND NOR XOR python unittest, material implication python code, contradiction tautology functions, project_first project_second, negate_first negate_second, binary operations TDD tutorial, if statement truth table python, conditional expression ternary operator boolean, De Morgan law refactor python, test_binary.py truth table, two boolean inputs four combinations, programming logic for beginners
