...
* I add a :ref:`function<what is a function?>` to ``traffic_light.py``
  ...
  because the test called the ``show`` :ref:`function<what is a function?>` with 2 keyword arguments and this definition only takes calls with 0 arguments
...
* I add the :ref:`keyword argument<test_functions_w_keyword_arguments>` to the :ref:`function<what is a function?>` in ``traffic_light.py``
  ...
  because the test called the ``show`` :ref:`function<what is a function?>` with 2 keyword arguments and this definition only takes calls with 1 input
...
* I add an :ref:`assertion<what is an assertion?>` for when the light is :yellow:`YELLOW`, the timer is :green:`done` and the walk button is :red:`NOT pushed`
  ...
  * I do not need to give a value for the ``walk_button`` parameter because
    ...
    the :ref:`default value<test_functions_w_optional_arguments>` for the ``walk_button`` parameter is :ref:`False<test_what_is_false>`. A :ref:`function<what is a function?>` uses the :ref:`default value<test_functions_w_optional_arguments>` for a parameter when it is called without the parameter.
