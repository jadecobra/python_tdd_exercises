...
In :ref:`test functions with None` I used :ref:`class attributes<what is a class attribute?>` to remove repetition from the :ref:`functions project<what is a function?>`. I want to use :ref:`variables<what is a variable?>` to do the same thing.
