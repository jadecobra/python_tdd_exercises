...
In :ref:`test functions with None` I used :ref:`object attributes<what is a object attribute?>` to remove repetition from the :ref:`functions project<what is a function?>`. I want to use :ref:`variables<what is a variable?>` to do the same thing.
