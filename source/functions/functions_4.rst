...
* I remove the ``x`` :ref:`variable<what is a variable?>`, then the :ref:`default values<test_optional_arguments>` from the ``add`` :ref:`function<what is a function?>`
