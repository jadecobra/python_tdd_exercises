...
* I add input to the :ref:`function call<how to call a function with input>`
  ...
  - The :ref:`function definition (signature)<how to make a function>` of ``positional_arguments`` does not allow any inputs when it is called, since the parentheses are empty.
  - I am violating the :ref:`function signature<how to make a function>` when I call it in a way that it was not designed to be called which raises :ref:`TypeError<what causes TypeError?>`.
...
* I make the :ref:`function<what is a function?>` take input by adding a name in parentheses
  ...
  .. code-block:: python
    ...
    def test_positional_arguments():
        # def positional_arguments():
        def positional_arguments(first_input):
            return None
...
* I add another input to the :ref:`function call<how to call a function with input>`
  ...
  - The :ref:`function definition (signature)<how to make a function>` of ``positional_arguments`` only allows one input.
  - I am violating the :ref:`function signature<how to make a function>` when I call it in a way that it was not designed to be called which raises :ref:`TypeError<what causes TypeError?>`.

* I make the :ref:`function<what is a function?>` take another input by adding a name in parentheses
...
* I change the expectation of the :ref:`assertion<what is an assertion?>`
  ...
  because when I call ``positional_arguments`` with ``'first'`` and ``'last'`` as inputs, it returns ``None``. Using substitution since :ref:`I can treat a call to a function as the object it returns<test_what_happens_after_functions_return>`
  ...
  which raises :ref:`AssertionError<what causes AssertionError?>` since :ref:`None is not a tuple<test_assertion_error_w_none>`.

* I change :ref:`the return statement` to make the :ref:`function<what is a function?>` return its inputs as output
...
* The problem with giving arguments this way is that they always have to be in the order the :ref:`function<what is a function?>` expects or I get something different. I add an :ref:`assertion<what is an assertion?>` to show this
  ...
  because the :ref:`function<what is a function?>` always returns ``first_input, last_input`` and the call in this test sends ``'last'`` as ``first_input`` and ``'first'`` as ``last_input``. Using substitution since :ref:`I can treat a call to a function as the object it returns<test_what_happens_after_functions_return>`
...
* I add a :ref:`function definition<how to make a function>`
...
* I add another :ref:`assertion<what is an assertion?>` with the `keyword arguments`_ given out of order in :ref:`test_keyword_arguments` in ``test_functions.py``
  ...
  Compare this call that uses :ref:`positional arguments<test_positional_arguments>` and its result
  ...
  with this call that uses :ref:`keyword arguments<test_keyword_arguments>` and its result
...
* I can still call the :ref:`function<what is a function?>` the same way I did in :ref:`test_positional_arguments` (without using the names). I add an :ref:`assertion<what is an assertion?>` to show this
...
* ``w_keyword_arguments`` and ``positional_arguments`` are the same functions_, they always
  ...
  I add another :ref:`assertion<what is an assertion?>` to show that the two :ref:`functions<what is a function?>` are the same, by calling the ``positional_arguments`` :ref:`function<what is a function?>` with :ref:`keyword arguments<test_keyword_arguments>`
...
I can write functions_ that take both :ref:`positional<test_positional_arguments>` and :ref:`keyword arguments<test_keyword_arguments>`, which is useful when I want some arguments to be required and some to be optional.
...
* I add a failing test to ``test_functions.py``
  ...
  because I cannot put :ref:`keyword arguments<test_keyword_arguments>` before :ref:`positional arguments<test_positional_arguments>`. The `Integrated Development Environment (IDE)`_ also shows the error with a red squiggly line under ``'first'``.
...
* I change the order of the arguments to follow Python_ rules
  ...
  because ``functions.py`` does not have anything named ``args_and_kwargs``
...
* I add a :ref:`function<what is a function?>`
  ...
  because the :ref:`definition<how to make a function>` for ``args_and_kwargs`` does not allow inputs and the test called the :ref:`function<what is a function?>` with a :ref:`keyword argument<test_keyword_arguments>` (``last_input``)

* I add the name to the :ref:`function definition<how to make a function>` in parentheses,
  ...
  because the :ref:`definition<how to make a function>` for ``args_and_kwargs`` takes one argument, and the test calls the :ref:`function<what is a function?>` with two arguments ``('first', last_input='last')``. How does Python_ know which value to use for ``last_input`` if I use the :ref:`position<test_positional_arguments>` and the :ref:`keyword<test_keyword_arguments>`?
...
* I add :ref:`variables<what is a variable?>` to use them to remove the repetition of ``'first'`` and ``'last'`` from :ref:`test_args_and_kwargs` in ``test_functions.py``
...
I can use :ref:`positional<test_positional_arguments>` and :ref:`keyword arguments<test_keyword_arguments>` when I want some arguments to be required and some to be optional.
...
I add a :ref:`function<what is a function?>` named ``w_optional_arguments``
...
* I make the argument optional by giving it a default value
...
.. tip::
  ...
  as a rule of thumb I use :ref:`keyword arguments<test_keyword_arguments>` when I have 2 or more inputs so I do not have to remember the order.
...
I can make functions_ that take any number of :ref:`positional<test_positional_arguments>` and :ref:`keyword<test_keyword_arguments>` arguments. This means I do not need to know how many inputs the :ref:`function<what is a function?>` should take when it is called.
...
* I add the name to the :ref:`function definition<how to make a function>`
  ...
  I had this same problem in :ref:`test_args_and_kwargs`. Python_ cannot tell if ``a`` is a :ref:`positional<test_positional_arguments>` or :ref:`keyword argument<test_keyword_arguments>` based on my :ref:`function definition<how to make a function>`.
...
* Python_ has a way for a :ref:`function<what is a function?>` to take any number of :ref:`keyword arguments<test_keyword_arguments>` without knowing how many they are. I use it to replace ``a`` in the parentheses
...
* I change the order of the inputs in ``w_unknown_arguments``
...
* I add an :ref:`assertion<what is an assertion?>` to see what happens when I call the :ref:`function<what is a function?>` with 3 :ref:`positional arguments<test_positional_arguments>`
  ...
  the :ref:`function definition<how to make a function>` only allows two :ref:`positional arguments<test_positional_arguments>`

* I change the definition of the ``w_unknown_arguments`` :ref:`function<what is a function?>` to make it take three :ref:`positional arguments<test_positional_arguments>`
...
* Python_ also has a way to handle any number of :ref:`positional arguments<test_positional_arguments>`. I use it
...
* I use the :ref:`variables<what is a variable?>` to remove repetition of the values
  ...
  because passing in the values this way means I am sending in two :ref:`positional arguments<test_positional_arguments>` - ``(a_tuple, a_dictionary)`` so I get a tuple_ with a tuple_ of the arguments and an empty :ref:`dictionary<what is a dictionary?>` instead of a tuple_ with the arguments in the tuple_ I sent and a :ref:`dictionary<what is a dictionary?>` with the :ref:`dictionary<what is a dictionary?>` I sent
...
I add an :ref:`assertion<what is an assertion?>` to see what happens when I call ``w_unknown_arguments`` with ONLY :ref:`positional arguments<test_positional_arguments>`.
...
the test passes. The :ref:`function<what is a function?>` gives me back the :ref:`positional arguments<test_positional_arguments>` in a tuple_ (things in parentheses (``()``) separated by commas) and gives me an empty :ref:`dictionary<what is a dictionary?>` (any :ref:`key-value pairs<test_items_returns_iterable_of_key_value_pairs_of_a_dictionary>` in curly braces ``{ }`` separated by a comma) for the :ref:`keyword arguments<test_keyword_arguments>` because I did not give any in the call.
...
* I remove the commented lines from the :ref:`w_unknown_arguments function<test_w_unknown_arguments>`
...
.. note::
  ...
  because ``w_unknown_arguments``  in the ``src`` folder will always
