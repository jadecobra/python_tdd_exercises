...
I add a test to ``test_functions_w_keyword_arguments``
...
- so I change the expected result of ``test_functions_w_keyword_arguments`` from the terminal's output
...
I add one more test to ``test_functions_w_keyword_arguments`` to drill the lesson
