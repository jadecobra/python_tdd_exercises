...
I add a new test with the `dir built-in function`_ to see the :ref:`attributes<what is a object attribute?>` and :ref:`methods<what is a method?>` of :ref:`dictionaries<what is a dictionary?>`
...
`unittest.TestCase.maxDiff`_ is a :ref:`object attribute<what is a object attribute?>` that is used to set the maximum length of differences between 2 items that the terminal_ is my friend, and shows
...
* I change the :ref:`assertEqual method<test_assert_equal>` to :ref:`assertRaises<another way to test if an Exception is raised>`
