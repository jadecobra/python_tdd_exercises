.. meta::
  ...
  :keywords: Jacob Itegboje, Pumping Python, what is None, python None, NoneType, simplest object python, None singleton, assertIsNone, assertIsNotNone, assertIs, assertIsNot, assertIsInstance, assertNotIsInstance, unexpectedly identical None, unexpectedly None, False is not None, 0 is not None, set() is not None, {} is not None, None is not False, None is not 0, None vs empty list, None vs empty dict, is None vs == None, empty set vs empty dict, set() vs {}, testing for None unittest, TDD None, red green refactor None, uv run pytest-watcher, remove the commented lines, test_what_is_none, test_none_v_boolean, test_none_v_dictionary, Python basic objects TDD
...
I want to use :ref:`assert methods<test_dir_unittest_testcase>` to compare :ref:`None<what is None?>` with the other :ref:`Python basic objects<basic objects>` to see what it is and what it is not.
...
* :ref:`how can I test if something is the same object as None?<another way to test if something is None>`
* :ref:`how can I test if something is NOT the same object as None?<another way to test if something is NOT None>`
...
* I open a terminal_
* I `change directory`_ to the ``none`` folder_ in the ``pumping_python`` folder_
...
* I use `pytest-watcher`_ to run the tests automatically
  ...
  .. code-block:: python
    ...
    ======================== FAILURES ========================
    _________________ TestNone.test_failure __________________
    ...
    FAILED tests/test_none.py::TestNone::test_failure - AssertionError: False != True
    =================== 1 failed in X.YZs ====================
...
- because :ref:`assertIsNotNone<another way to test if something is NOT None>` raises :ref:`AssertionError<what causes AssertionError?>` if the :ref:`object<everything is an object>` given in parentheses is :ref:`None<what is None?>`.
- ``assertIsNot(something, None)`` and ``assertIsNotNone(something)`` are the same.
...
I change :ref:`assertIsNotNone<another way to test if something is NOT None>` to the `assertIsNone method`_
...
I know two new :ref:`assert methods<test_dir_unittest_testcase>`

* :ref:`assertIsNotNone to test if something is NOT None<another way to test if something is NOT None>`.
* :ref:`assertIsNone to test if something is None<another way to test if something is None>`.
...
Is :ref:`None<what is None?>` a :ref:`boolean<what are booleans?>`?
...
I change :ref:`assertIsNone<another way to test if something is None>` to the :ref:`assertIsNotNone method<another way to test if something is NOT None>`
...
* I add a comment
  ...
  another comment from the :ref:`assertion_error project<what is an assertion?>`.
...
* I change :ref:`assertIsNone<another way to test if something is None>` to :ref:`assertIsNotNone<another way to test if something is NOT None>`
...
* I add :ref:`assertIsInstance<test_assert_is_instance>` to test if :ref:`None<what is None?>` is :ref:`an instance (a copy)<how to test if something is an instance>` of the :ref:`bool class<what are booleans?>`
  ...
  because :ref:`None is NOT a boolean<test_none_v_boolean>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_boolean'

:ref:`None is NOT a boolean<test_none_v_boolean>`.

The names of the :ref:`assert methods<test_dir_unittest_testcase>` can be confusing,

* there is ``assertIsNotNone`` where ``Not`` comes after ``Is``
* there is ``assertNotIsInstance`` where ``Is`` comes after ``Not``
...
Not in this case, because the names of the :ref:`assert methods<test_dir_unittest_testcase>` match the assert statements they replace
...
Is :ref:`None<what is None?>` an integer_?
...
I make the statement :ref:`True<test_what_is_true>` with :ref:`assertIsNotNone<another way to test if something is NOT None>`
...
* I add one more failing line to test if :ref:`None<what is None?>` is an integer_ with :ref:`assertIsInstance<test_assert_is_instance>`
  ...
  because :ref:`None is NOT an integer<test_none_v_integer>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_integer'

:ref:`None is NOT an integer<test_none_v_integer>`.
...
* I add one more failing line with the :ref:`assertIsInstance method<test_assert_is_instance>`
  ...
  because :ref:`None is NOT a float<test_none_v_float>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_float'

:ref:`None is NOT a float<test_none_v_float>`.
...
* I add a failing :ref:`assertion<what is an assertion?>` with :ref:`assertIsInstance<test_assert_is_instance>`
  ...
  because :ref:`None is NOT a string<test_none_v_string>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_string'

:ref:`None is NOT a string<test_none_v_string>`.
...
* I add one more :ref:`instance test<how to test if something is an instance>`
  ...
  because :ref:`None is NOT a tuple<test_none_v_tuple>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_tuple'


:ref:`None is NOT a tuple<test_none_v_tuple>`.
...
* I add one more failing line with the :ref:`assertIsInstance method<test_assert_is_instance>`
  ...
  because :ref:`None is NOT a list<test_none_v_list>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_list'

:ref:`None is NOT a list<test_none_v_list>`.
...
* I add an :ref:`instance test<how to test if something is an instance>`
...
* I add another :ref:`instance test<how to test if something is an instance>`
  ...
  because :ref:`None is NOT a set<test_none_v_set>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am 'add test_none_v_set'


:ref:`None is NOT a set<test_none_v_set>`

----

*********************************************************************************
test_none_v_dictionary
*********************************************************************************
...
* I add the last failing :ref:`instance test<how to test if something is an instance>` with :ref:`assertIsInstance<test_assert_is_instance>`
  ...
  because :ref:`None is NOT a dictionary<test_none_v_dictionary>`.
...
* I add a git_ commit message in the other terminal_
  ...
  .. code-block:: python
    ...
    git commit -am \
    'add test_none_v_dictionary'

:ref:`None is NOT a dictionary<test_none_v_dictionary>`.
