...
What follows is an exercise in measuring learning. It is somewhat philosophical in its meaning and arithmetic_ in its representation. I am curious to know what you think and what solutions you come up with
...
* I hold :kbd:`ctrl` (Windows_/Linux_) or :kbd:`option/command` (MacOS_) on the keyboard and use the mouse to click on ``tests/test_learning.py:7`` to put the cursor on line 7
