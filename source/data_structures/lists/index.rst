...
* I hold ``ctrl`` (Windows_/Linux_) or ``option or command`` (MacOS_) on the keyboard and use the mouse to click on ``tests/test_lists.py:7`` to open it in the :ref:`editor<2 editors>`
...
Would you like to :ref:`test list comprehensions?<lists: list comprehensions>` They are a quick way to make :ref:`lists`
