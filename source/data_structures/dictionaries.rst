...
I can get the value for a key in a `dictionary <https://docs.python.org/3/library/stdtypes.html#mapping-types-dict>`_ by giving it in ``[]``, this is like :ref:`viewing items in a list <test_view_items_in_a_list>`
