...
.. tab-set::
  ...
  .. tab-item:: WSL/Linux/Mac
    ...
    * If it is installed and there is nothing in the directory_, the terminal_ is my friend, and shows
    ...
    * If it is installed and there is something in the directory_, the terminal_ is my friend, and shows how they are related.
...
when you type pwd_ or tree_, the terminal_ is my friend, and shows ``\`` between folder_ names, not ``/``. Click the ``no WSL`` tab for an example
    ...
    .. tab-item:: WSL/Linux/Mac
      ...
      * ls_ has a few options. I try ls_ again with one of them
      ...
      .. attention::
        ...
        * on MacOS_ the terminal_ is my friend, and shows
