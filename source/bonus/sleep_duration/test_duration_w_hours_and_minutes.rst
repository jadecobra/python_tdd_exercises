...
* and change the first `return statement`_ in the ``duration`` :ref:`function<functions>` to a :ref:`variable<test_attribute_error_w_variables>` for the total difference in minutes
