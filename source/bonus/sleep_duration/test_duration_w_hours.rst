...
* I hold :kbd:`ctrl` (Windows_/Linux_) or ``option or command`` (MacOS_) on the keyboard and use the mouse to click on ``tests/test_sleep_duration.py:7`` to open it in the :ref:`editor<2 editors>`
